  ...
  <div class="container">
    <div class="row product">
      ...
      <div class="col-md-7">
        ...
        <button
          class="price btn btn-danger mt-3"
          @click="addToCartQuantity(product, quantity)"
        >
          THÊM VÀO GIỎ HÀNG
        </button>
      </div>
              ...
              <div class="card-body text-center">
                ...
                <div class="icon-hover d-flex">
                  <div class="icon-eye" @click="viewProduct">
                    <router-link
                      :to="{ name: 'DetailProduct', params: { id: item._id } }"
                      class="nav-link"
                    >
                      <i class="bi bi-eye"></i>
                    </router-link>
  ...
  methods: {
    async fetchfindOneProduct() {
      try {
        ...
        const similarProducts = await ProductService.findProductByCategory(
          categoryname,
          product
        );
