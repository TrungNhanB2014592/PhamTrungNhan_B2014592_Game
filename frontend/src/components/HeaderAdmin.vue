<template>
  <nav class="navbar navbar-expand-sm bg">
    <div class="container-fluid justity-content-between">
      ...
      <div class="mx-auto">
        <img src="/img/Mơ1.png" class="img-thumbnail" width="130" alt="" />
      </div>
  ...
  <div class="nav-content">
    <ul class="nav justify-content-center">
      ...
      <li class="">
        <p>
          <router-link to="/admin/categorys" class="nav-link"
    ...
    >
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="">
            <p>
              <router-link to="/admin/home" class="nav-link nav-text"
                >TRANG CHỦ</router-link
              >
            </p>
          </li>
          <li class="">
            <p>
              <router-link to="/admin/categorys" class="nav-link nav-text"
                >QUẢN LÝ DANH MỤC</router-link
              >
            </p>
          </li>
          <li class="">
            <p>
              <router-link to="/admin/products" class="nav-link nav-text"
                >QUẢN LÝ SẢN PHẨM</router-link
              >
            </p>
          </li>
          <li class="nav-item">
            <p>
              <router-link to="/admin/orders" class="nav-link nav-text"
                >QUẢN LÝ ĐƠN HÀNG</router-link
              >
            </p>
          </li>
          <li class="">
            <p>
              <router-link to="/admin/users" class="nav-link nav-text"
                >QUẢN LÝ NGƯỜI DÙNG</router-link
              >
            </p>
          </li>
