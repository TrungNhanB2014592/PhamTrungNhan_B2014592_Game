<template>
  <div>
    ...
    <div class="dropdown" v-else>
      <button
        class="btn btn-outline border-none outline-none btn-info4"
        type="button"
      ...
      <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-hidden">
        <li>
          <router-link
            ...
            >Thông tin hồ sơ</router-link
          >
        </li>

        <li>
          <router-link
            :to="{ name: 'Orders', params: { id: userId } }"
            class="nav-link text-white"
            >Đơn mua</router-link
          >
        </li>

        <li @click="logout" class="logout nav-link text-white">
