<template>
  <div v-if="searchResults.length > 0" class="text-center">
    <div class="search">
      <p>
        Kết quả tìm kiếm cho "<span class="search-keyword">{{ searchkey }}</span
        >"
      </p>
        ...
        <div class="row search-result">
          ...
          >
            ...
            <div class="product card-body text-center">
              ...
              <p class="card-price">
                {{
                  parseInt(result.price.replace(/\s/g, "")).toLocaleString(
                    "vi-VN"
                  )
                }}
                &#8363;
              ...
              <div class="icon-hover d-flex">
                <div class="icon-eye" @click="viewProduct">
                  <router-link
                    :to="{ name: 'DetailProduct', params: { id: result._id } }"
                    class="nav-link"
                  >
                    <i class="bi bi-eye"></i>
                  </router-link>
  ...
  <div v-else class="container card-notfound">
    <div class="card">
      <img
        ...
        class="card-img-top image-notfound mx-auto"
        alt="..."
      />
      <div class="card-body">
        <p>
          Không tìm thấy kết quả nào cho "<span class="search-keyword"
            >{{ searchkey }} </span
          >" !
        </p>
      </div>
