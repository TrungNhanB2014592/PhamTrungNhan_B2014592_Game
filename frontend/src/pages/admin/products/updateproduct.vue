  ...
  <div class="container">
    <div class="row product">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div
          v-if="showError"
          class="container error-message alert alert-danger"
          role="alert"
        >
          {{ error }}
        </div>
        ...
        <form
          class="justity-content-center align-items-center"
          enctype="multipart/form-data"
          @submit="updateProduct($event, productId)"
        >
          <div class="mb-3 form-group">
            <label for="exampleFormControlSelect1" class="title-product"
              >Danh Mục:</label
            >
            <select
              class="form-select"
          ...
          <div class="mb-3">
            <label
              ...
              class="form-label title-product"
              >Mô tả:
            </label>
            <textarea
              v-model="describe"
          ...
          <router-link to="/admin/products"
            ><button class="cancel btn">Hủy</button></router-link
          >
        </form>
      </div>
