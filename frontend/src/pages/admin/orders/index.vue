      ...
      <table class="table table-hover table-bordered text-center">
        ...
        <tbody>
          <tr v-for="(item, index) in orderItems" :key="item._id">
            ...
            <td>
              {{ item.details.grandTotalPrice.toLocaleString("vi-VN") }}&#8363;
            </td>
                      ...
                      <div class="modal-body">
                        <div class="container">
                          <table class="table table-hover text-center">
                            ...
                            <tbody>
                              <tr
                                v-for="(product, index) in item.details
                                  .ordercartItems"
                              ...
                              >
                                ...
                                <td>
                                  {{
                                    product.subtotalPrice.toLocaleString(
                                      "vi-VN"
                                    )
                                  }}&#8363;
                                </td>
                              ...
                              <tr>
                                ...
                                <th>
                                  Tổng Tiền:
                                  {{
                                    item.details.totalPrice.toLocaleString(
                                      "vi-VN"
                                    )
                                  }}&#8363;
                                </th>
            ...
            <td>
              <button class="btn update" @click="updateOrder(item.order._id)">
                Xử lí
              </button>
            </td>
          </tr>
